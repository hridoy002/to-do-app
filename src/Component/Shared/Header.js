...
import menu from '../../img/icons8-menu-squared-96.png'
        ...
        <div>
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100  w-52">
                            ...
                            <Link to='/taskDone'><li>Task Complete</li></Link>
                ...
                <div className="navbar-center">
                    <img src={logo} className="w-10" alt="" /> <span className='text-xl font-semibold'>Keep Note</span>
                </div>
